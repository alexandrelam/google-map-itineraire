    ...
    if(origin && destination){
        ...
        directionsService.route(request, function(response, status){ // Envoie de la requête pour calculer le parcours
            if(status == google.maps.DirectionsStatus.OK){
                ...
                // console.log(parseInt(point.duration.text));
                ...
                total = km_prix * parseInt(point.distance.text) + minute * parseInt(point.duration.text);
                console.log(total + " euros");

                 document.getElementById("demo").innerHTML ="Prix :  " + total.toFixed(2) + " euros";
